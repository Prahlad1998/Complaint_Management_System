...
<!-- '<div class="alert alert-danger" role="alert">There is an error in processing !</div>' -->
<!-- window.location.pathname -->

            <!-- <script type="text/javascript" > alert("Complain Id does not exist !");
